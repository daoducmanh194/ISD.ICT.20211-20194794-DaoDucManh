...
public class DVD extends Media {
    ...
    public DVD(int id, String title, String category, int price, int quantity, String type, String discType,
            String director, int runtime, String studio, String subtitles, Date releasedDate, String filmType, boolean isSupportRush) throws SQLException{
        super(id, title, category, price, quantity, type, isSupportRush);
    ...
    public Media getMediaById(int id) throws SQLException {
        ...
        Boolean isSupportRush = res.getBoolean("isSupportRush");

        return new DVD(id, title, category, price, quantity, type, discType, director, runtime, studio, subtitles, releasedDate, filmType, isSupportRush);
