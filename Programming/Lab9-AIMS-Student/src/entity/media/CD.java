...
public class CD extends Media {
    ...
    public CD(int id, String title, String category, int price, int quantity, String type, String artist,
            String recordLabel, String musicType, Date releasedDate, boolean isSupportRush) throws SQLException{
    ...
    public Media getMediaById(int id) throws SQLException {
		...
		if(res.next()) {
            ...
            return new CD(id, title, category, price, quantity, type, 
                          artist, recordLabel, musicType, releasedDate, isSupportRush);
